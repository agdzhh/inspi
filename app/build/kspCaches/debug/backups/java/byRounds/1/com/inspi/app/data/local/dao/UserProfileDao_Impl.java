...
import com.inspi.app.data.local.entities.UserProfileEntity;
  ...
  public UserProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserProfileEntity = new EntityInsertionAdapter<UserProfileEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_profile` (`id`,`username`,`hobby`,`totalXp`,`currentStreak`,`longestStreak`,`lastSubmissionDate`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(7, entity.getLastSubmissionDate());
      }
    };
  }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"user_profile"}, new Callable<UserProfileEntity>() {
      ...
      public UserProfileEntity call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfLastSubmissionDate = CursorUtil.getColumnIndexOrThrow(_cursor, "lastSubmissionDate");
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpLastSubmissionDate;
            _tmpLastSubmissionDate = _cursor.getLong(_cursorIndexOfLastSubmissionDate);
            _result = new UserProfileEntity(_tmpId,_tmpUsername,_tmpHobby,_tmpTotalXp,_tmpCurrentStreak,_tmpLongestStreak,_tmpLastSubmissionDate);
          } else {
            _result = null;
          }
          return _result;
