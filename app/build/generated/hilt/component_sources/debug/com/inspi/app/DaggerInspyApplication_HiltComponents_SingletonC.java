...
public final class DaggerInspyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends InspyApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.hobbySelectionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new CoachViewModel(singletonCImpl.coachRepositoryProvider.get(), singletonCImpl.userRepositoryProvider.get(), singletonCImpl.provideCoachApiServiceProvider.get());

          case 1: // com.inspi.app.ui.gallery.GalleryViewModel 
          return (T) new GalleryViewModel(singletonCImpl.submissionRepositoryProvider.get());

          case 2: // com.inspi.app.ui.hobbyselection.HobbySelectionViewModel 
          return (T) new HobbySelectionViewModel(singletonCImpl.userRepositoryProvider.get());

          case 3: // com.inspi.app.ui.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.userRepositoryProvider.get(), singletonCImpl.challengeRepositoryProvider.get());

          case 4: // com.inspi.app.ui.onboarding.OnboardingViewModel 
          return (T) new OnboardingViewModel(singletonCImpl.inspiPreferencesProvider.get());

          case 5: // com.inspi.app.ui.profile.ProfileViewModel 
          return (T) new ProfileViewModel(singletonCImpl.userRepositoryProvider.get(), singletonCImpl.submissionRepositoryProvider.get());

          case 6: // com.inspi.app.ui.taskcomplete.TaskCompleteViewModel 
          return (T) new TaskCompleteViewModel(singletonCImpl.userRepositoryProvider.get(), singletonCImpl.submissionRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
  ...
  private static final class SingletonCImpl extends InspyApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<InspiDatabase>(singletonCImpl, 1));
      this.coachRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<CoachRepository>(singletonCImpl, 0));
      this.inspiPreferencesProvider = DoubleCheck.provider(new SwitchingProvider<InspiPreferences>(singletonCImpl, 3));
      this.userRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<UserRepository>(singletonCImpl, 2));
      this.provideGeminiApiKeyProvider = DoubleCheck.provider(new SwitchingProvider<String>(singletonCImpl, 5));
      this.provideCoachApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<CoachApiService>(singletonCImpl, 4));
      this.submissionRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SubmissionRepository>(singletonCImpl, 6));
      this.challengeRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<ChallengeRepository>(singletonCImpl, 7));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.inspi.app.data.repository.CoachRepository 
          return (T) new CoachRepository(singletonCImpl.coachMessageDao());

          case 1: // com.inspi.app.data.local.InspiDatabase 
          ...
          case 3: // com.inspi.app.data.preferences.InspiPreferences 
          ...
          case 4: // com.inspi.app.network.CoachApiService 
          ...
          case 6: // com.inspi.app.data.repository.SubmissionRepository 
          return (T) new SubmissionRepository(singletonCImpl.submissionDao());

          case 7: // com.inspi.app.data.repository.ChallengeRepository 
