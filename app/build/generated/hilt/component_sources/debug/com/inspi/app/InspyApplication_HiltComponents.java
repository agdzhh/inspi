...
import com.inspi.app.di.AnalyticsModule;
import com.inspi.app.di.DatabaseModule;
import com.inspi.app.di.NetworkModule;
...
import com.inspi.app.utils.DailyReminderWorker_HiltModule;
import dagger.Binds;
...
public final class InspyApplication_HiltComponents {
  private InspyApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements InspyApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          CoachViewModel_HiltModules.BindsModule.class,
